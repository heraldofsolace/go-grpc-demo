...
func (c *taskServiceClient) RecordTasks(ctx context.Context, opts ...grpc.CallOption) (TaskService_RecordTasksClient, error) {
	stream, err := c.cc.NewStream(ctx, &TaskService_ServiceDesc.Streams[1], TaskService_RecordTasks_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &taskServiceRecordTasksClient{stream}
	return x, nil
}
...
func (c *taskServiceClient) TaskChat(ctx context.Context, opts ...grpc.CallOption) (TaskService_TaskChatClient, error) {
	stream, err := c.cc.NewStream(ctx, &TaskService_ServiceDesc.Streams[2], TaskService_TaskChat_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &taskServiceTaskChatClient{stream}
	return x, nil
}
...
func _TaskService_RecordTasks_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TaskServiceServer).RecordTasks(&taskServiceRecordTasksServer{stream})
}
...
func _TaskService_TaskChat_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TaskServiceServer).TaskChat(&taskServiceTaskChatServer{stream})
}
